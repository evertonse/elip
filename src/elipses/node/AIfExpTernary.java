...
public final class AIfExpTernary extends PExpTernary
{
    ...
    public AIfExpTernary(
        ...
        @SuppressWarnings("hiding") PExpUnary _falsy_)
    {
        // Constructor
        setKwIf(_kwIf_);
    ...
    public PExpUnary getFalsy()
    {
        return this._falsy_;
    }

    public void setFalsy(PExpUnary node)
    {
